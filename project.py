...
def lcs(X, Y, m, n): # m and n are the lengths of strings X and Y respectively
    ...
    if m == 0 or n == 0: 
       ...
       return max(lcs(X, Y, m, n-1), lcs(X, Y, m-1, n)); # Returns the length of the longest common sequence
